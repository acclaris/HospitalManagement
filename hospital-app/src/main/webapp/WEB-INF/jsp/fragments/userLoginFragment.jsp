...
<div id="login-box" class="page-container">
	<a href="#" class="close"><img src="/hospital-app/assets/img/fancybox_close.png" class="btn_close" title="Close Window" alt="Close" /></a> <br /> <span class="form-title">LOGIN</span>
	<div class="form-container">
		<div id="login-form-container" class="inner-form-container">
			<form id="user-login" action="../hospital-app/j_spring_security_check" method="post">
				<br />
				<input type="text" id="username" class="username" name="username" placeholder="Username" required /> <span class="tooltip">Username cannot be blank</span>
				<input type="password" id="password" name="password" class="password" placeholder="Password" required /> <span class="tooltip">Password cannot be blank</span>
				<button id="userLoginButton" type="submit">Sign In</button>
				<a id="forgot-password" href="/login/forgotpassword">Forgot Password ?</a> 
				<br />
				<br />
				<br />
				<br />
