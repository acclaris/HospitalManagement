...
<body>
	...
	<div class="page-container">
		<div class="button-container">
			<button id="login-user" class="btn btn-border color-1 material-design fancybox" href="app/login" data-color="#2f5398">LOG IN AS USER</button>
			
			<button id="book-appointment" class="btn btn-border color-1 material-design  fancybox" href="#" data-color="#2f5398">BOOK AN APPOINTMENT</button>

			<button id="view-patient-report" class="btn btn-border color-1 material-design  fancybox" href="#" data-color="#2f5398">VIEW PATIENT REPORT</button>
		</div>
